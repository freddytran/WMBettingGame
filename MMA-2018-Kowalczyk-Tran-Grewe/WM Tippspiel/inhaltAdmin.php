...
<div class="col-lg-12 alert-success">
    ...
    <form action="ergebnisEingabe.php" method="post">
...
<!--Zwischenüberschrift-->
    ...
    <div class="col-xs-12 col-lg-12">  
    <div class="container-fluid">
        <h1>Übersicht der Ergebnis eingebenn</h1>
        </div>    
         </div>
     </div>
    </div>

<!--Ergebnis eingeben Gruppenspiele --> 
...
<div class="modal fade" id="exampleModalA5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelA5" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabelA5">Heim : Gast</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<form action="ergebnisEingabe.php" method="post">
  ...
  Ergebnis eingeben
    ...
    $sqlTipp= "SELECT * FROM tipps WHERE BenutzerID='$id' AND spielID='GrBSp4'";
    ...
    $sqlCheck = "SELECT * FROM tipps WHERE spielID='GrBSp4' AND BenutzerID='$id'";
    ...
    $sqlErgebnis = "SELECT * FROM spielergebnis WHERE begegnungID='GrBSp4'";
    ...
    $sqlCheckErg = "SELECT * FROM spielergebnis WHERE begegnungID='GrBSp4'";
...
<div class="modal fade" id="exampleModalG6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelG6" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabelG6">Heim : Gast</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
